   ...
   <div class="toptool">
		...
		<div class="maincontent">
			...
			<div class="rightpanel" style="padding-top:30px;">
				...
				<div style="height:500px;">
				   <div style="padding-bottom:30px;"><a href="/travel/oa/querydiskfile.action" target="_blank" class="btn btn-success btn-sm" style="float:right;">新增文件</a></div>
				   <div style="width:90%;">
	...
	function GetDiskfileRow(diskfile){
		var row = "<tr>"
			...
			+ "<a href='/travel/oa/querydiskfile.action?id="+diskfile.id+"'>查看</a>"+
					"</td></tr>";
	    return row;
	}
