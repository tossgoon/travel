...
<meta http-equiv="description" content="组织架构">
<!--
	...
	<div class="maincontent" >
		<div class="leftpanel">
			<ul>
				...
				<li  class="activeli"><a href="">组织架构</a></li>
			</ul>
		</div>
		<div class="rightpanel" style="height:500px;">
			<div>
							<span style="font-size:18px;">组织架构</span>
							<input value="修改信息" onclick="InsertUser()" type="button"
