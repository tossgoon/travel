	...
	<div class="maincontent" >
		...
		<div class="rightpanel" style="height:500px;">
			            <div style="margin:10px;">
							...
							<a href="/travel/oaadmin/notifyedit.jsp" type="button" class="btn btn-primary" style="margin-right:20px; float:right;width:90px;" >新增数据</a>
						</div>
								...
								<tr align="center" height="24px">
									...
									<td>
									    <%-- <c:if test="${notify.status!=true}"> --%>
											<a href="/travel/oa/modifynotify.action?id=${notify.id}"
						...
						<div style="margin-top:10px;">
							<a id="firstpage"	href="/travel/notify/querypage.action?pagesize=10&pagenum=1">第一页</a>
							<a id="lastpage"	href="/travel/notify/querypage.action?pagesize=10&pagenum=${page.currentPage-1 }">上一页</a>
							<a id="nextpage"	href="/travel/notify/querypage.action?pagesize=10&pagenum=${page.currentPage+1 }">下一页</a>
							<a id="endpage"		href="/travel/notify/querypage.action?pagesize=10&pagenum=${page.totalPage }">最后一页</a>
