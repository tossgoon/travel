			   ...
			   <hr>
			    <form   id="formAnimal"  style="margin:0 auto;">
										...
										<div class="row">
											...
											<div class="col-md-4">
											       <div class="input-group date form_date"	data-date-format="yyyy-mm-dd">
															<s:textfield class="form-control input-sm"  name="camera.anzhuangriqi"  id="anzhuangriqi">
															</s:textfield>
										...
										<div class="row">
											...
											<div class="col-md-2"><span>海拔高度(高度)</span></div>
											<div class="col-md-4">
					...
					<div style="margin-top:10px;">
							<a href="/travel/survey/cameraedit.jsp"
